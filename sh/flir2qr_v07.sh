...
WWWPATH="/var/www/html/hotspotmaps";
if [ -e ${1}/${2} ]
...
*.tif)
  ...
  echo -e "${GREEN}Burning roads $TEMP_PATH/roads/${WILDFILE}_roads_rgb.tif${YELLOW}";
	...
	echo -e "${PURPLE}Adding $FLIR2QR_PATH/output/${WILDFILE}_basemap_wgs84.tif to $WWWPATH/ ${YELLOW}"; 
	cp -f $FLIR2QR_PATH/output/${WILDFILE}_basemap_wgs84.tif $WWWPATH/$WILDFILE.tif;
  ...
  mv -f $TEMP_PATH/kmz/${WILDFILE}.kml $WWWPATH/${WILDFILE}.kml;
	...
	qrencode -o $WWWPATH/qr/${WILDFILE}_tif.png http://$IP/hotspotmaps/$WILDFILE.tif;
  qrencode -o $WWWPATH/qr/${WILDFILE}_pdf.png http://$IP/hotspotmaps/$WILDFILE.pdf;
  qrencode -o $WWWPATH/qr/${WILDFILE}_kml.png http://$IP/hotspotmaps/$WILDFILE.kml/${WILDFILE}_basemap.kml;
