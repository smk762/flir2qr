...
*.tif)
    ...
    echo -e "${PURPLE}Processing IR Raster${YELLOW}";
   ...
   do
    ...
    echo -e "${PURPLE}Creating KM super overlay ${YELLOW}";
    ...
    echo -e "${PURPLE}generating QR hyperlink codes for $WILDFILE ${YELLOW}";
    ...
    echo -e "${PURPLE}Adding QR code image and ccentroid coordinates to KMZ template ${YELLOW}";
